    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto mt-12 max-w-3xl">
        <div class="rounded-lg bg-white shadow-xl">
          <!-- En-tête -->
          <div class="border-b border-light px-4 py-5 sm:px-6">
            <div class="flex items-center space-x-3">
              <div class="flex-shrink-0">
                <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-secondary-tertiary">
                  <SparklesIcon class="h-6 w-6 text-light" />
                </div>
              </div>
              <div>
                <h3 class="font-headers text-lg font-medium text-secondary">
                  Assistant Eden Labs
                </h3>
          ...
          <div
            ref="chatContainer"
            class="h-96 overflow-y-auto px-4 py-5 sm:p-6"
          >
            <div class="space-y-4">
              <template v-for="(message, index) in messages" :key="index">
                ...
                >
                  <div class="flex-shrink-0">
                    <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-secondary-tertiary">
                      <SparklesIcon class="h-5 w-5 text-light" />
                    </div>
                  </div>
                  <div class="ml-3">
                    <div class="max-w-lg rounded-lg bg-light/30 px-4 py-2">
                ...
                >
                  <div class="mr-3">
                    <div class="max-w-lg rounded-lg bg-gradient-secondary-tertiary px-4 py-2">
                  ...
                  <div class="flex-shrink-0">
                    <div class="h-8 w-8 rounded-full bg-light/50">
                      <UserCircleIcon class="h-8 w-8 text-secondary/50" />
                    </div>
                  </div>
                </div>
              </template>
              ...
              >
                ...
                <div class="ml-3">
                  <div class="rounded-lg bg-light/30 px-4 py-2">
                    <div class="flex space-x-1">
                      <div class="h-2 w-2 animate-bounce rounded-full bg-secondary/40"></div>
                      <div class="h-2 w-2 animate-bounce rounded-full bg-secondary/40" style="animation-delay: 0.2s"></div>
                      <div class="h-2 w-2 animate-bounce rounded-full bg-secondary/40" style="animation-delay: 0.4s"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Zone de saisie -->
          <div class="border-t border-light px-4 py-4 sm:px-6">
            <div class="flex space-x-3">
              <div class="flex-1">
                <input
                  v-model="newMessage"
                  type="text"
                  class="block w-full rounded-md border-light shadow-sm focus:border-primary focus:ring-primary sm:text-sm"
              ...
              <button
                type="button"
                class="inline-flex items-center rounded-md border-2 border-primary bg-primary px-4 py-2 text-sm font-medium text-secondary shadow-sm transition-colors duration-200 hover:bg-primary-light hover:border-primary-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                @click="sendMessage"
              >
                <PaperAirplaneIcon class="h-5 w-5" />
              </button>
            </div>
            <p class="mt-2 text-xs text-secondary/50">
      ...
      <div class="mt-12 text-center">
        ...
        <p class="mt-4 text-sm text-secondary/70">
